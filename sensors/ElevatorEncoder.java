...
public class ElevatorEncoder extends Encoder {
	 ...
	 */
	public ElevatorEncoder(int channelA, int channelB, boolean reverseDirection, EncodingType encodingType) {
	 ...
	 *                         used and the returned value will either exactly match the spec'd count
	 */
	public ElevatorEncoder(DigitalSource sourceA, DigitalSource sourceB, boolean reverseDirection, EncodingType encodingType) {
	 ...
	 * @param reverseDirection represents the orientation of the encoder and inverts the output values
	 */
	public ElevatorEncoder(DigitalSource sourceA, DigitalSource sourceB, DigitalSource indexSource, boolean reverseDirection) {
