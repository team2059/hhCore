...
/**
 * Wrapper around the ColorSensorV3 that maps the port to the I2C port on the RoboRio. This class is
 * mainly used in ColorMatcher and isn't meant to be invoked directly.
 */
