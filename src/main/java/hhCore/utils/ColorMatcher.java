...
/**
 * Uses HHColorSensor to match incoming color values with passed in colors. You are easily able to
 * change what color the sensor trys to match with and at what confidence level it should return.
 */
