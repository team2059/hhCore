...
/**
 * Wrapper around CANSparkMax that includes a default motor configuration and makes it easier to
 * change the configuration of the motor.
 */
public class HHSparkMax extends CANSparkMax {

  /**
   * Sets up the CAN Spark Max with the default settings on the device number provided and sets the
   * default motor type to brushless.
   *
