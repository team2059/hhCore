 ...
 * change the configuration of the motor. This is just a base configuration for a CAN Talon SRX.
 */
public class HHTalonSRX extends WPI_TalonSRX {
  ...
  /**
   * Sets up the Talon SRX with the default settings on the device number provided and sets the
   * control mode.
   *
